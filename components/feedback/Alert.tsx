 ...
 * Alert Component
 * 
 * An alert component for displaying important messages with variants,
 * dismissible option, icons, and action buttons.
 * 
 * @example
 * ```tsx
 * <Alert variant="error" message="An error occurred" dismissible />
 * 
 * <Alert
 *   variant="warning"
 *   title="Warning"
 ...
 * Alert Component
 * 
 * Displays an alert message with variant styling, optional dismiss button,
          ...
          <div className="mt-3">
            <button
              ...
              className={cn(
                ...
                'focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-marine-red',
