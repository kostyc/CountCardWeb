...
exports.getPrivilegeLevel = getPrivilegeLevel;
exports.getRolePermissions = getRolePermissions;
exports.hasPermission = hasPermission;
exports.canAccessOrganizationByRole = canAccessOrganizationByRole;
...
exports.ROLE_HIERARCHY = {
    ...
    drill_instructor: {
        ...
        privilegeLevel: types_1.PrivilegeLevel.Level1,
        permissions: [
            'view_own_platoon',
            'edit_own_platoon',
            'create_count_card',
    ...
    senior_drill_instructor: {
        ...
        privilegeLevel: types_1.PrivilegeLevel.Level2,
        permissions: [
            'view_own_platoon',
            'edit_own_platoon',
            'view_series',
    ...
    chief_drill_instructor: {
        ...
        privilegeLevel: types_1.PrivilegeLevel.Level3,
        permissions: [
            'view_own_platoon',
            'edit_own_platoon',
            'view_series',
 ...
 */
function getPrivilegeLevel(role) {
    return exports.ROLE_HIERARCHY[role].privilegeLevel;
}
/**
 * Get permissions for a given role
 */
function getRolePermissions(role) {
    return exports.ROLE_HIERARCHY[role].permissions;
}
/**
 * Check if a role has a specific permission
 */
function hasPermission(role, permission) {
    return exports.ROLE_HIERARCHY[role].permissions.includes(permission);
}
/**
 * Check if user can access target organization based on their role and organization
 */
function canAccessOrganizationByRole(userRole, userOrg, targetOrg) {
    const hierarchy = exports.ROLE_HIERARCHY[userRole];
